    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active"><a href="{{ URL('sirkulasi_pindah/insert') }}">Insert</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                        <form class="form-mover">
                            @include("Modul.Sirkulasi.Pindah.BaseForm.Form")
                        </form>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        $(".form-mover").submit(function(e){
            ...
            $.ajax({
                ...
                success: function(d){
                    ...
                    window.location.href = "{{URL('/sirkulasi_pindah')}}";
                },
                error: function(e){
                    if (e.status == 401) {
        ...
        $('#user').select2({
            ...
            theme: 'bootstrap4',
            placeholder: "Pilih Warga Pindah",
